...
<head>
    ...
    <title><?php if(isset($page)):echo($page);else:echo"Quizees";endif;?></title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?php if(isset($page) and $page == "Beranda"):echo"active";endif;?>">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-4 d-none d-lg-inline text-gray-800"><?= $usrn; ?></span>
                                <span style="font-size: 18pt;"><i class="fas fa-user-circle text-gray-800"></i></span>
                            </a>
